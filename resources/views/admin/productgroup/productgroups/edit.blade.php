    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('productgroups.update',['id'=>$productgroup->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-9 pt-3">
                            <div class="row">
                                <div class="col-lg-5">
                                    <input type="text" name="name" value="{{$productgroup->name}}" class="form-control" placeholder="Product Groups Name">
                                </div>
