...
<section class="featured spad">
    <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="featured__controls">
                    <ul>
                        ...
                        $category = DB::select("select * from categories order by id desc limit 4");
        ...
        <div class="row featured__filter">
            <?php
            $category1 = DB::select("select * from categories order by id desc limit 1");
            $category2 = DB::select("select * from categories order by id desc limit 2");
            $category3 = DB::select("select * from categories order by id desc limit 3");
            $category4 = DB::select("select * from categories order by id desc limit 4");
            ...
            $product1 = DB::select("select * from products where category_id='$category1'");
            $product2 = DB::select("select * from products where category_id='$category2'");
            $product3 = DB::select("select * from products where category_id='$category3'");
            $product4 = DB::select("select * from products where category_id='$category4'");
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix <?php echo Category::find($category1)->name; ?> ">
                <div class="featured__item">
                    ...
                    <div class="featured__item__text">
                        ...
                        <h5>${{$product->regularprice}}</h5>
                    </div>
                </div>
            </div>
            @endforeach
            @foreach($product2 as $product)
            <div class="col-lg-3 col-md-4 col-sm-6 mix <?php echo Category::find($category2)->name; ?> ">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="{{asset($product->photo)}}">
                        <ul class="featured__item__pic__hover">
                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix <?php echo Category::find($category3)->name; ?> ">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="{{asset($product->photo)}}">
                        <ul class="featured__item__pic__hover">
                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix <?php echo Category::find($category4)->name; ?> ">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="{{asset($product->photo)}}">
                        <ul class="featured__item__pic__hover">
                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
