    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header p-0 justify-content-centrer d-flex">
                ...
                <h4 class="card-title text-center bg-white" style='border:1px solid; border-radius:10px;padding:20px 60px; width:100%;'><b> Status Edit</b></h4>
            ...
            <div class="card-body">
                ...
                <form action="{{route('status.update',['id'=>$status->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{$status->name}}" class="form-control" placeholder="Status Name">
