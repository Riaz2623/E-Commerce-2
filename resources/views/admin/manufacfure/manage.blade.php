                ...
                <div class="pull-left">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody> @foreach($manufacures as $manufacure)
                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>{{$manufacure->name}}</td>
                                    <td>{{$manufacure->mobile}}</td>
                                    <td>{{$manufacure->address}}</td>
                                    <td>{{$manufacure->email}}</td>
                                    <td>
                                        <a href="{{route('manufacure.edit',['id'=>$manufacure->id])}}" class="btn btn-success btn-sm">
