...
<div class="card">
    ...
    <div class="card-header p-0 justify-content-centrer d-flex">
        ...
        <h4 class="card-title text-center bg-white" style='border:1px solid; border-radius:10px;padding:20px 60px; width:100%;'><b> Create Product</b></h4>
        ...
        <form action="{{route('new.product')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <input type="number" name="offerprice" class="form-control" placeholder="Offer Price">
                        <div class="input-group-append">
                    ...
                    <div class="input-group">
                        <input type="number" name="regularprice" class="form-control" placeholder="Regular Price">
                        <div class="input-group-append">
                    ...
                    <div class="input-group">
                        <input type="number" name="bar_code" class="form-control" placeholder="Bar_Code">
                        <div class="input-group-append">
                    ...
                    <div class="input-group">
                        <input type="number" name="offerdiscount" class="form-control" placeholder="Offer Discount">
                        <div class="input-group-append">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <textarea class="ckeditor" name="description" placeholder="Description"></textarea>
                    </div>
                    </br>
