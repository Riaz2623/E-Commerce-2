    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header p-0 justify-content-centrer d-flex">
                ...
                <h4 class="card-title text-center bg-white" style='border:1px solid; border-radius:10px;padding:20px 60px; width:100%;'><b> Create Transaction</b></h4>

            </div>
            <div class="card-body">
                <div class="pull-left">
                    <a class="btn btn-primary" href="{{route('transaction.manage')}}"> Transaction Section</a>
                </div>
                </br>
                </br>
