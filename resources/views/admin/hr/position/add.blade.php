...
<div class="card">
    ...
    <div class="card-header p-0 justify-content-centrer d-flex">
        ...
        <h4 class="card-title text-center bg-white" style='border:1px solid; border-radius:10px;padding:20px 60px; width:100%;'><b>Create Position</b></h4>
    ...
    <div class="card-body">
        ...
        <form action="{{route('new.position')}}" method="POST" enctype="multipart/form-data">
            @csrf
